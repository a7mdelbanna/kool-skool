...
-- Final fix for ambiguous student_id column reference in create_group_subscription function
-- Rename the loop variable to avoid conflict with table column names
...
DECLARE
  ...
  current_student_uuid UUID; -- Renamed to avoid ambiguity with table columns
...
BEGIN
  ...
  FOREACH current_student_uuid IN ARRAY p_student_ids -- Use renamed variable
  LOOP
    ...
    INSERT INTO public.subscriptions (
      ...
      current_student_uuid, -- Use renamed variable
      p_group_id,
      'group',
    ...
    VALUES (p_group_id, current_student_uuid, p_start_date) -- Use renamed variable
    ...
    WHILE sessions_created < group_record.session_count LOOP
      ...
      -- Insert the session with clear variable reference
      INSERT INTO public.lesson_sessions (
        ...
        new_subscription_id,
        current_student_uuid, -- Use renamed variable to eliminate ambiguity
        p_group_id,
        session_datetime,
