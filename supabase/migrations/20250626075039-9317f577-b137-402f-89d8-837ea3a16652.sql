...
-- Update the add_student_subscription function to properly include the payment parameters
-- This will ensure the TypeScript types are generated correctly
...
BEGIN
  ...
  IF p_initial_payment_amount > 0 THEN
    INSERT INTO public.student_payments (
      ...
      p_payment_method,
      'completed',
      COALESCE(p_payment_notes, 'Initial payment for subscription')
    );
  END IF;
