...
-- Create RPC function to add student subscription with custom auth validation
...
BEGIN
  ...
  SELECT * INTO current_user_record FROM public.users WHERE id = p_current_user_id;
