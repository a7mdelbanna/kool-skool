...
// Helper function to fetch team members with separate profile query for better type safety
...
// Helper function for creating a team member directly with Supabase Auth
export const createTeamMember = async ({
  ...
  try {
    ...
    return { success: true, teamMemberId, userId: authData.user.id };
  } catch (error) {
...
// Helper function for deleting a team member
