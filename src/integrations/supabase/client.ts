...
export const addStudentSubscription = async (subscriptionData: {
  ...
  try {
    ...
    console.log('✅ Subscription with initial payment created successfully:', data);
    return data;
    
  } catch (error) {
    console.error('❌ Unexpected error in addStudentSubscription:', error);
    throw error;
  }
};

export const deleteStudentSubscription = async (subscriptionId: string) => {
  console.log('🗑️ USING DATABASE FUNCTION: deleteStudentSubscription called with subscriptionId:', subscriptionId);
  ...
  try {
    console.log('🔧 Calling database function delete_student_subscription...');
    ...
    console.log('✅ SUCCESS: Subscription deleted successfully via database function');
    console.log('📊 Sessions deleted:', response.sessions_deleted);
